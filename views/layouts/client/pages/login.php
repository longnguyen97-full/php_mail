      ...
      <div class="container">
        <div class="row align-items-center py-5">
          ...
          <div class="col-lg-5 px-lg-4">
            <h1 class="text-base text-primary text-uppercase mb-4">Bubbly Signin</h1>
            <h2 class="mb-4">Welcome User!</h2>
            <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
            
            <form id="loginForm" action="?controller=home&action=handleLogin" method="post" class="mt-4">
              ...
              <button type="button" class="btn btn-primary shadow px-5"><a href="" class="anchor-link-unset">Back</a></button>
              &nbsp;
